...
Verbinden Sie Ihr Ökosystem (z. B. eine Lösung für den Handel) mit Experience Cloud, indem Sie [Adobe I/O Runtime](https://developer.adobe.com/apis/experienceplatform/runtime.html), eine auf Micro-Services basierenden PaaS-Lösung ohne Server, und die [CIF-Referenzimplementierung](https://github.com/adobe/commerce-cif-graphql-integration-reference) nutzen.
