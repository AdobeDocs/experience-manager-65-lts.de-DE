...
>
>Je nach Ihrer Instanz verfügen Sie möglicherweise über benutzerdefinierte Komponenten, die explizit für Ihre Anforderungen entwickelt wurden. Möglicherweise haben sie sogar denselben Namen wie einige der hier behandelten Komponenten.
...
* [Kernkomponenten](https://experienceleague.adobe.com/de/docs/experience-manager-core-components/using/introduction) - Die Kernkomponenten bieten flexible und vielseitige Authoring-Funktionen, die wichtige Inhaltstypen zur Erstellung von Seiten bereitstellen.
...
* Wenn Ihre Seite auf der empfohlenen, modernen, bearbeitbaren Vorlage basiert, können Sie [Vorlage ändern](/help/sites-authoring/templates.md) sie aktivieren oder deaktivieren und Parameter für bestimmte Komponenten bearbeiten.
* Wenn Ihre Seite auf einer statischen Vorlage basiert, können Sie den [Design-Modus](/help/sites-authoring/default-components-designmode.md#enable-disable-components) verwenden, um sie zu aktivieren oder zu deaktivieren und Parameter für bestimmte Komponenten zu bearbeiten.
