...
description: Erfahren Sie, wie Adobe Experience Manager 6.5 LTS personalisierte Inhalte erstellen kann.
...
Mit der [Aktivitätskonsole](/help/sites-authoring/activitylib.md) können Sie die Aktivitäten Ihrer Marken erstellen und verwalten. Sie können auch Aktivitäten erstellen, während Sie [zielgerichteten Inhalt erstellen.](/help/sites-authoring/content-targeting-touch.md)
...
Mit der [Angebotskonsole](/help/sites-authoring/offerlib.md) können Sie Angebote erstellen, die Sie für mehrere Erlebnisse einsetzen können. Erstellen Sie Angebote für den einmaligen Gebrauch oder fügen Sie Angebote aus einer Angebotsbibliothek hinzu, wenn Sie [zielgerichteten Inhalt erstellen.](/help/sites-authoring/content-targeting-touch.md)
...
Sie können diese Engine verwenden, wenn Sie über [eine Integration mit Adobe Target verfügen.](/help/sites-administering/opt-in.md)
