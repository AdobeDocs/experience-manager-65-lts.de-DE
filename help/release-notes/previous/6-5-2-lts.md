...
* Es wurde eine Configuration Manager (LCM) Express Mode-Eingabeaufforderung für die AEM-Administratorberechtigungen während der Konfiguration hinzugefügt, wobei die integrierten Standardberechtigungen ersetzt wurden. Diese Verbesserung ist über den 6.5 LTS SP2 JEE-Hotfix verfügbar. (FORMS-26704)
...
* Die Fokusverwaltung im Rich-Text-Feld „Beschreibung“ wurde korrigiert, sodass die Vorwärtsnavigation mit der Tabulatortaste nicht mehr blockiert wird. Benutzende blieben im RTE stecken, weil die Komponente einen nicht standardmäßigen Tastaturbefehl zum Verschieben des Fokus verwendete, was die erwartete Dialogfeldnavigation blockierte. Die Änderung erzwingt die standardmäßige Tastaturinteraktion und behält die logische Tab-Sequenz im gesamten Dialogfeld bei. (SITES-35228)
* Ein Problem im Sites-Editor wurde behoben, das das erwartete Verhalten während der Seitenbearbeitung störte und zu inkonsistenter Komponenteninteraktion führte. Bei Autorinnen und Autoren traten unzuverlässige Reaktionen der Benutzeroberfläche auf, die standardmäßige Bearbeitungsaufgaben beeinträchtigten und die Effizienz des Workflows verringerten. Die Aktualisierung optimiert die zugrunde liegende Editor-Logik und stellt eine stabile, vorhersehbare Interaktion über die betroffenen Komponenten hinweg wieder her. (SITES-35227)
* Eine Regression beeinträchtigte die Asset-Auswahl im Seiten-Editor und verhinderte, dass sie in bestimmten Szenarien der Seitenbearbeitung geladen wurde. Autorinnen und Autoren können die Asset-Auswahl jetzt beim Bearbeiten einer Seite wieder normal öffnen und verwenden, um Assets auszuwählen oder zu durchsuchen. Diese Änderung stellt den konsistenten Zugriff auf Asset-Auswahl-Workflows wieder her, der durch Ladefehler beeinträchtigt war. (SITES-35226)
...
* Fehlende Ansagen von Bildschirmlesehilfen bezüglich Fehlern beim Auswählen von Links in Dialogfeldern wurden behoben. Die Benutzeroberfläche gibt Fehlertext jetzt über einen Statusmeldungs-Container aus, sodass NVDA die Nachricht vorliest, sobald sie angezeigt wird. (SITES-25368)
...
* Die Fokussequenz in den Assets der Seitenleiste wurde korrigiert. Tastaturbenutzende erreichen jetzt alle Asset-Aktionen, einschließlich „Bearbeiten“, über eine konsistente Tabulatorreihenfolge. (SITES-25360)
* Layout-Überlauf im Assets-Modal „Suche“ bei einer Viewport-Breite von 320 Pixeln wurde behoben. Modal-Inhalte brechen jetzt korrekt um und bleiben lesbar, sodass sich Steuerelemente nicht mehr überschneiden oder über das Dialogfeld hinausragen. (SITES-25330)
...
* Die falsche Ansagereihenfolge für die Labels „Kleinere Bildschirme“ und „Tablet“ auf dem Lineal „Layout bearbeiten“ wurde korrigiert. Bildschirmlesehilfen geben diese Labels nun an den richtigen Linealmarken aus, die der Seite entsprechen. (SITES-25291)
* Ein Überlauf der Symbolleiste „Layout bearbeiten“ bei 200 % Zoom wurde behoben. Content bleibt jetzt innerhalb des Viewports und ist durch Scrollen erreichbar. (SITES-25288)
...
* Die Fokusbehandlung für das modale Dialogfeld „Anmerkung“ wurde korrigiert. Das Öffnen des Dialogfelds legt jetzt den Fokus auf den Dialogtitel und verhindert, dass NVDA Arbeitsflächeninhalte und irrelevanten Dialogfeldtext liest. Die Tastaturnavigation bleibt jetzt bis zum Schließen innerhalb des Dialogfelds. (SITES-25257)
* Layout-Probleme im modalen Dialogfeld „Suche“ bei einer Breite von 320 Pixeln wurden behoben. Modal-Inhalte brechen jetzt korrekt um und überlappen sich nicht mehr mit dem Baumverzeichnis. Benutzende können Ergebnisse anzeigen und im Verzeichnis navigieren, ohne dass Steuerelemente verdeckt werden. (SITES-25246)
* Text im Modal „Suche“ wird nicht mehr abgeschnitten, wenn sich der Textabstand vergrößert. Das Baumverzeichnis-Layout bleibt jetzt stets klar getrennt, sodass Label und Einträge lesbar bleiben. Benutzende können jetzt Suche und Navigation ohne überlappenden oder abgeschnittenen Text abschließen. (SITES-25245)
* Durch Aktivieren von „Kommentar einfügen“ wird der Tastaturfokus jetzt in den Anmerkungsinhalt verschoben, nicht auf die Schaltfläche „Anmerkungsmodus beenden“. Die Tabulatorreihenfolge folgt einer logischen Sequenz und hält zusammengehörige Steuerelemente ohne Rückwärtsnavigation erreichbar. (SITES-25241)
* Die Links „Datum einstellen“ und „Timewarp beenden“ hatten bei der Tastaturnavigation keinen sichtbaren Fokusindikator. Die Benutzeroberfläche zeigt jetzt einen eindeutigen Fokusstil mit hohem Kontrast an, sodass Benutzende den aktiven Link auf einen Blick erkennen können. (SITES-25232)
...
* AEM verwendet jetzt ein aussagekräftiges barrierefreies Label für die Schaltfläche „Info“ im Modal „Teaser“. Bildschirmlesehilfen geben einen eindeutigen Aktionsnamen anstelle des Alt-Text-Strings für das Standardsymbol aus. (SITES-25223)
* Bildschirmlesehilfen sagen jetzt die richtige Aktion an, wenn Benutzende die Schaltfläche „Bearbeiten“ aktivieren. NVDA meldet nicht mehr „Vorschau-Schaltfläche gedrückt“, was irreführendes Feedback und Verwirrung bei der Tastaturnavigation verursachte. (SITES-25208)
* Beim Erweitern der linken Leiste wird der Tastaturfokus jetzt auf das erste Steuerelement der linken Leiste verschoben. Die Tabulatorsequenz springt nicht mehr zur sekundären Symbolleiste oder landet mitten in der Liste, sodass Tastaturbenutzende die Inhalte der linken Leiste ohne Rückwärtsnavigation erreichen können. (SITES-24998)
...
* Das Dialogfeld für die Link-Auswahl richtet nun das programmgesteuerte Label am Bildschirm-Label für Baumstrukturelemente der letzten Ebene aus. Die Pfeiltasten-Navigation löst für jedes Element eine verlässliche Ansage der Bildschirmlesehilfe aus und entfernt irreführende Label-Ausgaben. (SITES-24710)
...
* Das Auswahldialogfeld zum Öffnen von Links setzt den Tastaturfokus nach dem Schließen oder Abbrechen wieder auf die Schaltfläche zurück, mit der das Dialogfeld geöffnet wurde. Der Fokus springt nicht mehr zur Link-Eingabe, wodurch der Kontext der Bildschirmlesehilfe stabil bleibt und die zusätzliche Navigation reduziert wird. (SITES-24707)
...
* Das modale Dialogfeld „Leiste ,Verweise‘“ hält den Tastaturfokus jetzt innerhalb des Dialogfelds. Tab und Umschalt+Tab bleiben innerhalb der Steuerelemente des Dialogfelds, und der Fokus wechselt nicht mehr zu den Seiteninhalten. Bildschirmlesehilfen sagen nur den Inhalt des Dialogfelds an. (SITES-24683)
...
* Das Suchfeld verwendet jetzt ein dauerhaft sichtbares Label anstelle von Platzhaltertext. Das Label bleibt während der Eingabe sichtbar, wodurch die Klarheit für Benutzende von Tastatur, Bildschirmlesehilfen und Sprachsteuerung verbessert wird. (SITES-24529)
...
* Das Assets-Panel in der Seitenleiste enthält jetzt eine Schaltfläche zum Schließen. Durch Schließen wird der Tastaturfokus auf den Umschalter für die Seitenleiste zurückgesetzt und das erzwungene Durchblättern des Panel-Inhalts wird verhindert. (SITES-24489)
* Die Tastaturnavigation mit der Tabulatortaste erreicht jetzt Schaltflächen und Links in Admin-Tabellen. Benutzende müssen sich bei der Suche nach interaktiven Steuerelementen nicht mehr auf die Zellennavigation mit den Pfeiltasten beschränken. (SITES-24285)
* Das Dialogfeld „Bildkomponente“ exponiert dekorative Hilfs- und Vollbildsymbole nicht mehr als Bilder. Bildschirmlesehilfen überspringen diese Symbole jetzt, sodass der Fokus auf interaktiven Steuerelementen und Feldinhalten verbleibt. (SITES-2940)
* Sites Admin entfernt jetzt die Rolle „Bild“ aus den Miniatursymbolen für Ordner. Assistive Technologien überspringen diese dekorativen Elemente, sodass der Fokus auf Ordnernamen und Aktionen bleibt. (SITES-2852)
* Die Inhaltsstruktur leitet den Tastaturfokus jetzt an das aktive Baumstrukturelement oder das erste Baumstrukturelement weiter. Der Baum-Container fungiert nicht mehr als leerer Tabstopp, wodurch Fokusfallen bei Umschalt+Tab verhindert werden. (SITES-1577)
...
* Bearbeitete Inhaltsfragmente verschwanden aus der Assets-Konsolenliste, nachdem Autorinnen und Autoren aus dem Inhaltsfragment-Editor zurückkehrten. Die Browser-Zwischenspeicherung gab eine veraltete Liste zurück und das aktualisierte Fragment blieb bis zu einer manuellen Aktualisierung ausgeblendet. Durch die Korrektur wird die Verarbeitung der Cache-Control-Anweisungen für den Rückkehrpfad des Editors hinzugefügt, damit die Liste korrekt neu geladen wird und das bearbeitete Fragment sichtbar bleibt. (SITES-35374) KRITISCH

* Der Inhaltsfragment-RTE zeigte nach den letzten Änderungen am Stil der Benutzeroberfläche Layout- und visuelle Probleme. Service Pack 2 optimiert die RTE-Formatierung, sodass die Symbolleiste und der bearbeitbare Bereich korrekt dargestellt werden und lesbar bleiben. Der Inhaltsfragment-Editor wird jetzt am Erscheinungsbild und Verhalten des Seiteneditors ausgerichtet. (SITES-38684)
* Das Entfernen von IMS-Bereichen aus der Polaris-Asset-Auswahl unterbrach die Integration von Inhaltsfragmenten mit dem Bereitstellungsendpunkt. Beim Öffnen der Remote-Asset-Auswahl und beim Auswählen von Assets traten bei Autorinnen und Autoren Fehler auf. Die Aktualisierung fügt die erforderlichen IMS-Bereiche wieder hinzu und stellt den stabilen Zugriff auf die Bereitstellungsebene wieder her. (SITES-35837)
* Das Panel „Zugehörige Inhalte“ rendert keinen hartcodierten Platzhalter „undefined“ mehr. Der Inhaltsfragment-Editor löst diesen Text jetzt über Lokalisierungsressourcen auf, sodass Bearbeitende übersetzten UI-Text sehen. (SITES-33675)
...
* Im Inhaltsfragment-Editor wird das Label der Registerkarte „Allgemein“ jetzt in allen Sprachgebieten übersetzt angezeigt. Der Editor ersetzt nicht lokalisierten Registerkartentext und entfernt interne IDs aus Registerkartentiteln. (SITES-30715)
* Der Inhaltsfragment-Editor zeigt jetzt übersetzte Namen für zulässige Asset-Typen an. In der Auswahlliste werden keine internen Zeichenfolgen und ausschließlich englische Labels mehr gemischt, wenn Autorinnen und Autoren Einschränkungen für Inhaltsreferenzen konfigurieren. (SITES-29699)
...
* Das Dialogfeld „GraphQL-Endpunkt bearbeiten“ zeigt jetzt lokalisierte Zeichenfolgen der Benutzeroberfläche an. Das Dialogfeld zeigt keinen ausschließlich englischen Text mehr an, z. B. „GraphQL schema is taken from configuration“, und die zugehörigen Labels werden in allen Gebietsschemata korrekt dargestellt. (SITES-34018)
...
* GraphQL Explorer schlägt nicht mehr fehl, wenn der Name eines Konfigurations-Browsers CJK-Zeichen enthält. Die Endpunkterstellung und der Zugriff auf gespeicherte Abfragen funktionieren normal, und die Seite des GraphQL-Abfrage-Editors bleibt fehlerfrei. (SITES-31616)
...
* Das Filter-Panel für Inhaltsfragmentmodelle zeigt keine nicht lokalisierten Zeichenfolgen mehr an. AEM zeigt jetzt lokalisierte Filter-Label und lokalisierte Statuswerte für alle Gebietsschemata an. (SITES-30863)
* Der Inhaltsfragmentmodell-Editor rendert jetzt lokalisierte Zeichenfolgen für das Warnungsdialogfeld zur Sperrung. Die Benutzeroberfläche ersetzt nicht lokalisierte englische Nachrichten durch Gebietsschema-Ressourcen in allen unterstützten Sprachen. (SITES-28592)
...
* Während der Launch-Promotion zeigte die Sites-Timeline hartcodierten englischen Text an: „Created version ... before promoting launch“. Die Aktualisierung ersetzt die hartcodierte Zeichenfolge durch die Verarbeitung lokalisierter Meldungen. Die Timeline zeigt jetzt lokalisierten Text an und stimmt den Eintrag mit dem standardmäßigen AEM-Lokalisierungsverhalten ab. (SITES-39157)
* Der Umfang der Launch-Promotion verschob sich, wenn Autorinnen und Autoren einen Unterabschnitt mit der Option „Aktuelle Seite und Unterseiten bewerben“ bewarben. AEM bewarb auch irrelevante Seiten und verursachte unerwartete Änderungen an der Live-Site. Durch die Korrektur wird die Berechnung des Launch-Umfangs berichtigt, sodass nur die ausgewählte Unterstruktur beworben wird. (SITES-38315)
* Inhaltsfragmente in Launches waren nicht am `damAssetLucene`-Index beteiligt und schränkten die Suchergebnisse und die Abfrageeffizienz ein. Durch diese Änderung werden Pfade von Launch-Inhaltsfragmenten zur Indexdefinition hinzugefügt. Suchvorgänge und benutzerdefinierte Abfragen finden jetzt Inhaltsfragmente unter „`/content/launches`“. (SITES-35634)
* In der Launches-Benutzeroberfläche wurden die Launch-Steuerelemente für Inhaltsfragmente angezeigt, obwohl das Produkt keine Inhaltsfragment-Launches in der Touch-optimierten UI bereitstellt. Durch diese Änderung werden die Code-Pfade für Inhaltsfragment-Launches aus cq-launches-content entfernt und die Filterung der Launch-Liste angepasst. Autorinnen und Autoren sehen jetzt konsistente Optionen für den Seiten-Launch ohne Inhaltsfragment-Launch-Einträge. (SITES-35633)
* Im AEM 6.5 LTS-Schnellstart fehlten erforderliche Launches-Pakete und Voraussetzungen, wodurch die OpenAPI-Aktivierung von Launches blockiert wurde. Die Aktualisierung fügt Launch-Pakete und erforderliche Abhängigkeiten hinzu, z. B. Unterstützung von Metriken, DAM-cfm-Aktualisierungen und Warteschlangenkonfiguration. Launches-APIs werden jetzt auf dem 6.5 LTS-Schnellstart ausgeführt, wobei die erforderlichen Laufzeitkomponenten vorhanden sind. (SITES-35297)
...
* AEM Launches führt jetzt eine dedizierte Jenkins-Pipeline für die 6.5 LTS-Verzweigung aus. Die Pipeline führt nächtliche Builds aus und sendet Fehlerwarnungen per E-Mail. Dieses Setup erhöht die Testabdeckung und erkennt Regressionen frühzeitig. (SITES-35293)
* AEM 6.5 LTS stellt jetzt ein aktualisiertes Launches-API-Paket mit abgestimmten Artefaktversionen bereit. Das Paket folgt der primären Code-Zeile und behält dabei die korrekte Release-Version für 6.5 LTS bei. Dieses Update stabilisiert die Nutzung der Launches-API im gesamten 6.5 LTS-Stack. (SITES-35292)
...
* AEM 6.5 LTS enthält jetzt die Side-Port-Anpassungen für die Launches OpenAPI. Durch die Aktualisierung werden Launches-API-Pakete, Content-Pakete und erforderliche Schnellstart-Artefakte aufeinander abgestimmt und Inhaltsfragment-Launches-OpenAPI-Szenarien mit stabiler CI-Validierung ermöglicht. (SITES-32050)
...
* Die Benutzeroberfläche der Launch-Promotion zeigt jetzt lokalisierte Status-Labels und Aktionen an. Im Vorschaubereich werden übersetzte Texte für **Deleted**, **New** und **View** anstelle von rohen englischen Zeichenfolgen angezeigt. (SITES-13540)
...
Die Seiteneditor-Veröffentlichung verarbeitet jetzt URLs, die Selektoren oder Suffixe enthalten. Die Veröffentlichungsanfrage sendet jetzt den JCR-Seitenpfad und keine Selektor- oder Suffix-URL-Zeichenfolge, sodass die Aktivierung erfolgreich abgeschlossen wird und der Inhalt live geschaltet wird. Die Replikation gibt jetzt bei einem Fehler den Fehlerstatus zurück, wodurch falsche „Veröffentlichung gestartet“-Meldungen verhindert werden. (NPR-43288)

<!-- #### Rich Text Editor{#sites-rte-65-lts-sp2} -->

#### Vorlageneditor{#sites-template-editor-65-lts-sp2}

Der Text zum Vorlagenstatus unter **Tools** > **Allgemein** > **&#x200B;**&#x200B;wurde für einige Gebietsschemata vertikal angezeigt. Das Label „veraltet“ unterbrach das Layout und wurde als Zeichenspalte gelesen. Die Korrektur behebt das Styling des Vorlagenstatus, sodass das Label in einer einzigen horizontalen Zeile dargestellt wird. (SITES-36797)
...
Assets-Korrelation funktioniert jetzt für Dateinamen mit Leerzeichen. Aktualisierte Korrelations-Client-Logik verarbeitet jetzt Pfade mit Leerzeichen korrekt und vermeidet „`undefined`“-Quellenfehler bei der Beziehungsauswahl. Das Dialogfeld „Korrelieren“ wird jetzt geöffnet und speichert Beziehungen, ohne dass die UI hängen bleibt oder das Ladesymbol angezeigt wird. DAM-Benutzende können Assets korrelieren, ableiten und die Korrelation aufheben, ohne Dateien umzubenennen. (Assets-56418)
...
* Ein Problem wurde behoben, bei dem die Option „Miniatur auswählen“ im Dialogfeld „Videoeigenschaften“ die Asset-Auswahl nicht öffnete. Benutzende können nun wieder benutzerdefinierte Miniaturansichten für Video-Assets auswählen. (Assets-58926)
...
* Auf Mobilgeräten wurde in der Tabellenkomponente in adaptiven Formularen oben eine ausgeblendete Kopfzeile angezeigt, sodass Bildschirmlesehilfen den Inhalt falsch ansagten. Dies betraf Benutzende, die für die Navigation auf Bildschirmlesehilfen angewiesen waren. (FORMS-23754)
...
* Die Formularübermittlung schlägt nach dem Upgrade auf AEM 6.5 LTS SP1 fehl. Bei Benutzenden fehlte com.adobe.cq.social.commons.CollabUtil, was zu JSP-Kompilierungsfehlern und Fehlern bei E-Mail-Aktionen führte. (FORMS-23457)
* Benutzende hatten Probleme damit, dass hCaptcha in adaptiven Formularen auf Basis von Foundation-Komponenten nicht ordnungsgemäß übersetzt wurde. Dadurch hatten nicht englischsprachige Benutzende Probleme, Formulare korrekt auszufüllen. (FORMS-23426)
...
* Im Dashboard für adaptive Formulare trat eine Sicherheitslücke auf. Insbesondere wurde ein Problem mit Cross-Site-Scripting (XSS) in der Datei „startpointcontrol.js“ erkannt, das die Ausführung bösartiger Skripte ermöglichen könnte. (FORMS-20679)
...
**Die folgenden Probleme wurden im AEM Forms 6.5 LTS Service Pack 2 JEE-Hotfix (Build 6.6.0-0006) behoben. Um sie anzuwenden, [laden Sie den Hotfix herunter und installieren Sie](/help/forms/using/adobe-experience-manager-forms-65-lts-hotfixes.md).**

* Nachdem Apache Shiro auf Version 2.1.0 aktualisiert wurde, konnte AEM Forms on JEE kein Bootstrapping mit einem `NoClassDefFoundError` für den Shiro-Sicherheits-Manager durchführen. Das Bootstrapping wurde jetzt erfolgreich abgeschlossen. (FORMS-26818)
* AEM Forms on JEE ist mit dem Fehler „Keine Klasse gefunden“ für `org.owasp.esapi.reference.JavaLogFactory` fehlgeschlagen. Die fehlende Klasse wird jetzt aufgelöst. (FORMS-26819)
* Nach der Aktualisierung auf AEM Forms 6.5 LTS wurden TaskManager-Endpunkte entfernt. Die Endpunkte werden jetzt beibehalten. (FORMS-26584, FORMS-26589)
* Auf JEE ist der Schritt „Configuration Manager MergeEars“ mit einem DOCTYPE-Deklarationsfehler (`ALC-LCM-010-200`) aufgrund des sicheren XML-Builders fehlgeschlagen. Das Zusammenführen von Ohren ist jetzt abgeschlossen. (FORMS-26569)
* Auf IBM® WebSphere® Liberty-Bereitstellungen fehlten Protokolle auf Anwendungsebene. Die Protokollierung auf Anwendungsebene wird jetzt wiederhergestellt. (FORMS-25063)
* Auf JBoss® ist die E-Mail mit „IMAPProvider ist kein Untertyp“ fehlgeschlagen. E-Mail funktioniert jetzt auf JBoss®. (FORMS-24892)
* Im WebSphere® Liberty Profile (WLP) ist die E-Mail mit „Socket konnte nicht in TLS konvertiert werden“ fehlgeschlagen. E-Mail über TLS funktioniert jetzt auf WLP. (FORMS-24692)
* Die Gibson-Bibliothek wurde auf Version 6.0.29665850 aktualisiert. (FORMS-26688)
* Verbesserungen bei der rückportierten SAML-Bestätigungsvalidierung. (FORMS-25222)
* Apache Log4j wurde auf Version 2.25.5 aktualisiert. (FORMS-26733, FORMS-26734)
* Dieses Hotfix enthält auch Sicherheitskorrekturen.
...
* AEM löscht die Einstellungen der Blockierungsliste und Zulassungsliste der Deserialisierungs-Firewall bei Paketaktualisierungsvorgängen nicht mehr. Die aktualisierte Filterregistrierungslogik sorgt dafür, dass die aktive Firewall-Instanz mit der gespeicherten Konfiguration übereinstimmt, sodass der Schutz ohne Neustart aktiviert bleibt. (GRANITE-61382)
* Die Felix-Web-Konsole gibt während des Zugriffs auf „`/system/console`“ keine periodischen Fehler „`NullPointerException`“ mehr aus. Die aktualisierte ServiceTracker-Verarbeitung verhindert einen Nullstatus des Trackers. Konsolenanmeldung und -navigation bleiben bei wiederholten Anfragen und automatisierter Validierung stabil. (GRANITE-61042)
...
* Sling aktualisiert die Zulassungsliste für administrative Logins für die Verwendung inklusiver Terminologie und neuer Konfigurations-PIDs. Diese Änderung entspricht Sling JCR Base 3.2.0. (GRANITE-63756)

  **Auswirkungen**

  * Sling markiert diese PIDs als veraltet, und Sie sollten sie aus Ihren Konfigurationen entfernen:
  ...
  * Sling bietet weiterhin teilweise Abwärtskompatibilität für die veralteten PIDs. Verwenden Sie sie jedoch nicht für neue Konfigurationen. Verwenden Sie stattdessen die neueren „`LoginAdminAllowList.*`“-PIDs.
  * Führen Sie veraltete und neue Konfigurationen für Zulassungslisten nicht gleichzeitig aus. Gemischte Konfigurationen können Mehrdeutigkeiten verursachen und zu unbeabsichtigtem Verhalten führen. Wenn Sie zu AEM 6.5 LTS SP2 migrieren, entfernen Sie die veralteten PIDs vollständig.
...
AEM enthält jetzt Sling Engine 2.16.6. Durch diese Änderung werden von Sicherheits-Tools gemeldete XSS-Verstöße beseitigt und die Sicherheit und Stabilität des Core-Renderings verbessert. (NPR-43105)
...
Kundinnen und Kunden werden aufgefordert zu prüfen, ob sie die Funktion in ihrer aktuellen Bereitstellung verwenden. Planen Sie, die Implementierung so zu ändern, dass die bereitgestellte Alternative verwendet wird.
...
>[!CAUTION]
>
> Entfernen Sie alle Kommentare aus JSON-Dateien in Ihren `Sling-Initial-Content`-Paketen, damit es nach dem Upgrade auf AEM 6.5 LTS SP2 nicht zu Fehlern beim Laden von Inhalten kommt.
