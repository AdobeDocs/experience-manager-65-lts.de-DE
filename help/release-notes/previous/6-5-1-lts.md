...
Bei der Online-Komprimierung kam es zu einer Beschädigung des Repositorys, wenn zuvor eine Offline-Komprimierung auf dem JCR-Repository ausgeführt worden war. In diesem Szenario kann ein `SegmentNotFoundException` (SNFE) auftreten. Dies kann zu einer Beschädigung des Repositorys führen.
...
>[!NOTE]
>
> Verwenden Sie für alle Oak-run-Vorgänge [oak-run 1.78.1-B006 jar](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar) (oben verlinkt).
