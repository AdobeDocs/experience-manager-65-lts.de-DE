...
* **FORMS-24688:** Beim Einrichten von JBoss EAP 8.0 (AEM Forms 6.5.1 LTS) unter Linux können unter Windows geänderte Skripte CRLF-Zeilenendungen enthalten, was zu Fehlern bei /bin/sh^M: ungültiger Interpreter oder $&#39;\r&#39;: Befehl nicht gefunden führt. Konvertieren Sie die betroffenen SH-Dateien mithilfe von dos2unix in das Unix-Format (z. B. nach . -type f -name &quot;*.sh“ -exec dos2unix {} +), um das Problem zu beheben.
