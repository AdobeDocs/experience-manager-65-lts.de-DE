...
ht-degree: 67%
---
# Dokumentation zu Adobe Experience Manager 6.5 LTS {#content}
...
+ Sicherheit {#security}
  ...
  + [Erstellen einer geschlossenen Benutzergruppe](/help/sites-administering/cug.md)
  ...
  + [Granite-Vorgänge – Benutzer- und Gruppenadministration](/help/sites-administering/granite-user-group-admin.md)
  ...
  + [Zuordnung benutzerdefinierter Benutzergruppen](/help/sites-administering/cug-mapping.md)
...
+ Sites {#sites}
  + Authoring {#authoring}
    ...
    + Performance einer Seite {#page-performance}
      + [Inhalterkenntnisse](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/authoring/siteandpage/content-insights.html?lang=de)
  ...
  + Verwalten {#administering}
    + [Überblick über das Benutzerhandbuch für Admins](/help/sites-administering/home.md)
    + Sites-Funktionen {#introduction}
      ...
      + [Konsole „Live Copy-Überblick“](/help/sites-administering/msm-livecopy-overview.md)
    ...
    + Vorgänge {#operations}
      ...
      + [Konfigurieren von RTE für die Erstellung barrierefreier Sites](/help/sites-administering/rte-accessible-content.md)
      + [Konfigurieren von „Rückgängig“ für die Seitenbearbeitung](/help/sites-administering/config-undo.md)
    ...
    + Personalisierung {#personalization}
      ...
      + [Konfigurieren von ContextHub](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/personlization/ch-configuring.html?lang=de)
    ...
    + Integration {#integration}
      + [Integrieren mit Drittanbieter-Services](/help/sites-administering/third-party-services.md)
      + [Integration mit Salesforce](/help/sites-administering/salesforce.md)
      + [Integration mit Adobe Target](/help/sites-administering/target.md)
      + [Integration mit Adobe Learning Manager](/help/sites-administering/adobe-learningmanager.md)
      ...
      + [Integration mit dem dynamischen Tag-Management von Adobe](/help/sites-administering/dtm.md)
      ...
      + [Integration mit Dynamic Media Classic (Scene7)](/help/sites-administering/scene7.md)
      ...
      + [Integration mit Adobe Campaign](/help/sites-administering/campaign.md)
    ...
    + Best Practices {#bestpractices}
      ...
      + [Best Practices für die Übersetzung](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/administering/introduction/tc-bp.html?lang=de)
      + [Best Practices für MSM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/administering/introduction/msm-best-practices.html?lang=de)
      + [AEM Sites – Einhaltung der DSGVO](/help/sites-administering/gdpr-compliance-sites.md)
      + [Handhabung von DSGVO-bezogenen Anfragen in AEM Foundation](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/security/handling-gdpr-requests-for-aem-platform.html?lang=de)
...
+ Assets {#assets}
  ...
  + Dynamic Media{#dynamic}
    ...
    + [Fehlerbehebung im Scene7-Modus von Dynamic Media](/help/assets/troubleshoot-dms7.md)
    ...
    + [Intelligente Bildbearbeitung mit Client-seitigem Geräte-Pixel-Verhältnis](/help/assets/client-side-dpr.md)
    ...
    + [Erstellen benutzerdefinierter Popups mithilfe der Schnellansicht](/help/assets/custom-pop-ups.md)
  ...
  + Verwalten von Assets {#administer}
    ...
    + [XMP-Writeback in Ausgabedarstellungen](/help/assets/xmp-writeback.md)
...
+ Forms {#forms}
  + [Hotfix für AEM Forms Service Pack](/help/forms/using/adobe-experience-manager-forms-65-lts-hotfixes.md)
  + Erste Schritte {#getting-started}
    ...
    + [Einführung in den Dienst für die automatische Formularkonvertierung](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/introduction.html?lang=de)
    + Tutorial: Erstellen Ihres ersten adaptiven Formulars {#create-first-adaptive-form}
      ...
      + [Tutorial: Erstellen eines adaptiven Formulars](/help/forms/using/create-adaptive-form.md)
      + [Tutorial: Erstellen eines Formulardatenmodells](/help/forms/using/create-form-data-model.md)
    ...
    + Tutorial: Erstellen Ihrer ersten interaktiven Kommunikation {#create-first-interactive-communication}
      ...
      + [Tutorial: Erstellen eines Formulardatenmodells](/help/forms/using/create-form-data-model0.md)
    ...
    + AEM Forms-Referenzmaterial {#aem-forms-reference-collaterals}
      ...
      + [Schrittweise Anleitung für eine Referenz-Site für Mitarbeiterrekrutierung](/help/forms/using/employee-recruitment-reference-site.md)
      + [We.Finance-Referenz-Site für die Verlängerung der Kfz-Versicherung](/help/forms/using/finance-auto-insurance-renewal-reference-site-walkthrough.md)
      + [FOIA-Anleitung zur We.Gov-Referenz-Site](/help/forms/using/gov-reference-site-foia-walkthrough.md)
  ...
  + Installieren und Konfigurieren von AEM Forms {#install-aem-forms}
    ...
    + [Installations- und Upgrade-Workflow für AEM Forms on JEE](/help/forms/using/aem-forms-jee-installation-upgrade-documentation.md)
    + Installieren von AEM Forms auf JEE {#jee-installation}
      ...
      + [Vorbereiten der Installation von AEM Forms (Einzel-Server)](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/prepare-install-single-server.pdf)
      + [Installieren und Bereitstellen von AEM Forms 6.5 LTS on JEE mithilfe von JBoss Turnkey](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/install-turnkey.pdf)
      + [Installieren und Bereitstellen von AEM Forms on JEE für JBoss](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/install-jboss.pdf)
      + [Installieren und Bereitstellen von AEM Forms on JEE für WebSphere Liberty Profile](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/install-websphere.pdf)
      + [Vorbereiten der Installation von AEM Forms (Cluster-Server)](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/prepare-install-cluster.pdf)
      + [Konfigurieren von AEM Forms on JEE auf einem JBoss-Cluster](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/cluster-jboss.pdf)
      + [Konfigurieren von AEM Forms on JEE auf einem WebSphere Liberty-Profilcluster](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/cluster-websphere.pdf)
      + [Handbuch zum Einrichten des Speichers für Datenbankberechtigungen (eigenständiger Modus)](/help/forms/using/database-credentials-store-setup-guide-standalone-mode.md)
      + [Setup für den Datenbank-Berechtigungsspeicher (auf Elytron-Basis)](/help/forms/using/database-credential-store-setup-elytron-based.md)
      + [Einrichtung der Sekundären Knotenauthentifizierung (auf Elytron-Basis)](/help/forms/using/secondary-node-authentication-setup-elytron-based.md)
    + Installieren von AEM Forms auf OSGi {#osgi-installation}
      ...
      + [Installieren und Konfigurieren interaktiver Kommunikationen](/help/forms/using/installing-configuring-intreactive-communication-correspondence-management.md)
    ...
    + Konfigurieren von AEM Forms {#configure-aem-forms}
      ...
      + {hide-from-toc}[Konfigurieren von AEM Forms zum Senden von Formulardaten an einen AEM Forms on JEE-Prozess](/help/forms/using/submit-form-data-livecycle-process.md)
      + [Desktop-Anwendung von AEM für AEM Forms](/help/forms/using/aem-desktop-app-for-aem-forms.md)
  + Upgrade von AEM Forms {#upgrade-aem-forms}
    ...
    + Upgrade von AEM Forms auf OSGi {#aem-forms-osgi-upgrade}
      ...
      + [Aktualisieren von AEM 6.5 LTS auf JBoss EAP 8 (Windows)](/help/forms/using/upgrading-aem-65-lts-on-jboss-eap-8.md)
    + Upgrade von AEM Forms auf JEE {#aem-forms-jee-upgrade}
      + [Vorbereiten der Aktualisierung von AEM Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/prepare-upgrade.pdf)
      + [Aktualisieren auf AEM Forms 6.5 LTS on JEE für JBoss Turnkey](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/upgrade-turnkey.pdf)
      + [Aktualisieren auf AEM Forms on JEE für JBoss](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/upgrade-jboss.pdf)
      + [Aktualisieren auf AEM Forms on JEE für WebSphere Liberty Profile](https://helpx.adobe.com/content/dam/help/en/experience-manager/65LTS/forms/upgrade-websphere.pdf)
  + Verwalten von AEM Forms {#manage-administer-aem-forms}
    + [Gruppen und Berechtigungen für AEM Forms auf OSGi](/help/forms/using/forms-groups-privileges-tasks.md)
    ...
    + [Herunterladen einer XFA- oder PDF-Formularvorlage](/help/forms/using/download-xfa-or-pdf-form.md)
    + [Löschen von Formularen und zugehörigen Ressourcen](/help/forms/using/deleting-forms-related-resources.md)
    + [Abrufen von XDP- und PDF-Dokumenten in AEM Forms](/help/forms/using/get-xdp-pdf-documents-aem.md)
    ...
    + Umgang mit Benutzerdaten {#handling-user-data}
      + {hide-from-toc}[Forms-zentrierte Workflows unter OSGi](/help/forms/using/forms-workflow-osgi-handling-user-data.md)
    ...
    + Härten der AEM Forms-Umgebung {#hardening-aem-forms-environment}
      ...
      + {hide-from-toc}[Allgemeine Überlegungen zur Sicherheit von AEM Forms on JEE](/help/forms/using/general-security-considerations.md)
      + {hide-from-toc}[Härten der AEM Forms on JEE-Umgebung](/help/forms/using/hardening-aem-forms-jee-environment.md)
      + {hide-from-toc}[Konfigurieren sicherer Administrationseinstellungen für AEM Forms on JEE](/help/forms/using/configuring-secure-administration-settings-aem.md)
  + Formulardatenmodell {#form-data-model}
    ...
    + [Konfiguration von Microsoft Dynamics OData](/help/forms/using/ms-dynamics-odata-configuration.md)
  ...
  + Adaptive Formulare – Kernkomponenten {#adaptive-forms-core-components}
    ...
    + [Erstellen und Verwenden einer benutzerdefinierten Funktion in einem adaptiven Formular auf Basis von Kernkomponenten](/help/forms/using/create-and-use-custom-functions-core-components.md)
    + [Erstellen und Verwenden eines benutzerdefinierten Fehler-Handlers für auf Kernkomponenten basierende adaptive Formulare](/help/forms/using/add-custom-error-handler-adaptive-forms-core-components.md)
  ...
  + Adaptiv Forms – Grundlegendes Authoring {#adaptive-forms-basic-authoring}
    ...
    + [Einbetten eines adaptiven Formulars oder einer interaktiven Kommunikation in eine AEM Sites-Seite](/help/forms/using/embed-adaptive-form-aem-sites.md)
    + [Einbetten eines adaptiven Formulars in externe Web-Seite](/help/forms/using/embed-adaptive-form-external-web-page.md)
    ...
    + [Verbinden und Übermitteln von Daten adaptiver Formulare an Microsoft® Power Automate](/help/forms/using/forms-microsoft-power-automate-integration.md)
  + Adaptive Formulare – Erweitertes Authoring {#adaptive-forms-advanced-authoring}
    ...
    + [Erstellen adaptiver Formulare mithilfe des XML-Schemas](/help/forms/using/adaptive-form-xml-schema-form-model.md)
    ...
    + [Hinzufügen von Informationen aus Benutzerdaten zu den Metadaten der Formularübermittlung](/help/forms/using/form-submission-metadata.md)
    ...
    + [Verwenden des AEM-Übersetzungs-Workflows zum Lokalisieren adaptiver Formulare und des Nachweises](/help/forms/using/using-aem-translation-workflow-to-localize-adaptive-forms.md)
    ...
    + [Erstellen und Verwalten von Bewertungen für Assets in Formularen](/help/forms/using/create-reviews-forms.md)
    + [Einbetten eines adaptiven Formulars oder einer interaktiven Kommunikation in eine Single Page Application von AEM Sites](/help/forms/using/embed-adaptive-form-aem-sites-spa.md)
    ...
    + [Erstellen und Verwenden eines benutzerdefinierten Fehler-Handlers für adaptive Formulare](/help/forms/using/standard-validation-error-messages-adaptive-forms.md)
  + Interaktive Kommunikationen {#interactive-communications}
    + [Einführung in die Authoring-Benutzeroberfläche für interaktive Kommunikation](/help/forms/using/introduction-interactive-communication-authoring.md)
    ...
    + [Vorbereiten und Senden einer interaktiven Kommunikation mithilfe der Agent-Benutzeroberfläche](/help/forms/using/prepare-send-interactive-communication.md)
    + [Print-Kanal und Web-Kanal](/help/forms/using/web-channel-print-channel.md)
  ...
  + Workflows {#workflows}
    ...
    + [Dynamische Auswahl einer Person oder Gruppe für AEM Forms-zentrierte Workflow-Schritte](/help/forms/using/dynamically-select-a-user-or-group-for-aem-workflow.md)
    + {hide-from-toc}[Aktionen und Funktionen formularzentrierter AEM-Workflows in OSGi- und AEM Forms JEE-Workflows](/help/forms/using/capabilities-osgi-jee-workflows.md)
    + [Starten der Document Services-APIs aus dem AEM-Workflow](/help/forms/using/initiating-document-services-apis-aem.md)
  ...
  + AEM Forms Workspace {#use-aem-forms-workspace}
    ...
    + [Im AEM Forms-Arbeitsbereich nicht verfügbare Funktionen des Flex-Arbeitsbereichs](/help/forms/using/features-flex-workspace-available-html.md)
    ...
    + [Anpassen der Seite mit Aufgabendetails](/help/forms/using/customizing-task-details-page.md)
    ...
    + [Im AEM Forms-Arbeitsbereich verwendete APIs](/help/forms/using/apis-used-html-workspace.md)
    ...
    + [Anzeigen von Informationen im Bereich „Aufgabenzusammenfassung“](/help/forms/using/displaying-information-task-summary-pane.md)
    ...
    + [Verwalten von Aufgaben in einer organisatorischen Hierarchie mithilfe der Manager-Ansicht](/help/forms/using/tasks-organizational-hierarchy-using-manager.md)
    ...
    + [Richtlinien zur Fehlerbehebung für einen AEM Forms-Arbeitsbereich](/help/forms/using/troubleshooting-guidelines-html-workspace.md)
  + AEM Forms-App {#aem-forms-app}
    + [Einführung in die AEM Forms-App](/help/forms/using/aem-forms-app.md)
    ...
    + [Einrichten des Android™ Studio-Projekts und Erstellen der Android™-App](/help/forms/using/setup-android-studio-project-build-installer.md)
    + [Erstellen der AEM Forms Android™-App](/help/forms/using/setup-eclipse-project-build-installer.md)
    ...
    + [Fehlerbehebung für die AEM Forms-App](/help/forms/using/issues-aem-forms-app.md)
  + HTML5-Formulare {#html5-forms}
    ...
    + [Erstellen benutzerdefinierter Erscheinungsbilder in HTML5-Formularen](/help/forms/using/custom-widgets.md)
  ...
  + Briefe und Korrespondenz {#letters-correspondences}
    ...
    + [Verwalten von Agent-Unterschriftbildern](/help/forms/using/manage-agent-signature-images.md)
    ...
    + [Hinzufügen benutzerdefinierter Aktionen/Schaltflächen in der Benutzeroberfläche „Korrespondenz erstellen“](/help/forms/using/add-action-button-in-create-correspondence-ui.md)
    + [Hinzufügen von benutzerdefinierten Eigenschaften zu den Correspondence Management-Assets](/help/forms/using/add-custom-properties-cm-assets.md)
    ...
    + [Integrieren der Benutzeroberfläche „Korrespondenz erstellen“ in ein benutzerdefiniertes Portal](/help/forms/using/integrating-create-correspondence-ui-with-your-portal.md)
    + [Benutzerdefinierte Sonderzeichen in Correspondence Management](/help/forms/using/custom-special-characters.md)
    + [Benutzerdefiniertes Wasserzeichen in der PDF-Vorschau des Briefs](/help/forms/using/custom-watermark.md)
    ...
    + [Eigenschaften der Correspondence Management-Konfiguration](/help/forms/using/cm-configuration-properties.md)
  + Integrieren von AEM Forms mit Experience Cloud-Lösungen {#integrate-aem-forms-with-experience-cloud-solutions}
    ...
    + [Anzeigen und Verstehen der Analyseberichte in AEM Forms](/help/forms/using/view-understand-aem-forms-analytics-reports.md)
  ...
  + Veröffentlichen und Verarbeiten von AEM-Formularen {#publish-process-aem-forms}
    ...
    + [Beispiel für die Integration der Komponente für Entwürfe und Übermittlungen mit einer Datenbank](/help/forms/using/integrate-draft-submission-database.md)
    ...
    + [Veröffentlichen und Aufheben der Veröffentlichung von Formularen und Dokumenten](/help/forms/using/publishing-unpublishing-forms.md)
    + [Auflisten von Formularen auf einer Web-Seite mithilfe von APIs](/help/forms/using/listing-forms-webpage-using-apis.md)
    + [Öffnen und Ausfüllen veröffentlichter Formulare](/help/forms/using/accessing-filling-published-forms.md)
    + [Senden einer Bestätigung für den Formularversand per E-Mail](/help/forms/using/form-submission-receipt-via-email.md)
  ...
  + Document Services {#use-document-services}
    ...
    + [Verwenden von HSM, um Dokumente digital zu signieren oder zu zertifizieren](/help/forms/using/hsm-certify-esign-docs.md)
  ...
  + Dokumentensicherheit {#use-document-security}
    ...
    + [Reader-Erweiterung richtliniengeschützter PDF-Dokumente mit der Portable Protection Library](/help/forms/using/reader-extending-policy-protected-pdf-documents-using-ppl.md)
    + [Aktivieren von AEM, um durch Document Security geschützte PDF- und Microsoft Office-Dokumente zu durchsuchen](/help/forms/using/enable-search-for-drm-protected-pdf-and-office-documents-in-aem.md)
  ...
  + Forms Designer {#use-forms-designer}
    ...
    + [Verwenden der Freihand-Signatur in HTML5-Formularen](/help/forms/using/scribble-signature.md)
  ...
  + Anpassen von AEM Forms {#customize-aem-forms}
    ...
    + [Erstellen einer benutzerdefinierten Vorlage für ein adaptives Formular](/help/forms/using/custom-adaptive-forms-templates.md)
    ...
    + [Hinzufügen benutzerdefinierter Aktionen zu Formularlisten-Elementen](/help/forms/using/add-custom-action-form-lister.md)
    ...
    + [Anpassen des Formularereignis-Trackings](/help/forms/using/customizing-form-event-tracking.md)
    ...
    + [Erstellen benutzerdefinierter Designs für adaptive Formulare](/help/forms/using/creating-custom-adaptive-form-themes.md)
  + Transaktionsberichte {#transaction-reports}
    ...
    + Transaktionsberichte für AEM Forms auf OSGi {#transaction-reports-osgi}
      ...
      + {hide-from-toc}[Aktivieren und Anzeigen von Transaktionsberichten](/help/forms/using/transaction-report-overview-jee.md)
      + {hide-from-toc}[Liste der kostenpflichtigen APIs für AEM Forms on JEE](/help/forms/using/transaction-reports-billable-apis-jee.md)
      + {hide-from-toc}[Aufzeichnen einer Transaktion für benutzerdefinierte Komponenten-APIs](/help/forms/using/record-transaction-custom-component-jee.md)
  + Administratorhilfe für AEM Forms auf JEE {#administrator-help}
    + Erste Schritte {#get-started}
      + {hide-from-toc}[Allgemeine AEM Forms-Einstellungen](/help/forms/using/admin-help/configure-general-aem-forms-settings.md)
      + {hide-from-toc}[Aktualisieren des Lizenztyps für die Bereitstellung](/help/forms/using/admin-help/update-license-type-deployment.md)
    + Einrichten und Verwalten von Domains {#setup-manage-domains}
      + {hide-from-toc}[Hinzufügen von Domains](/help/forms/using/admin-help/adding-domains.md)
      + {hide-from-toc}[Löschen einer Domain](/help/forms/using/admin-help/delete-domain.md)
      + {hide-from-toc}[Einstellungen für die Kontosperrung konfigurieren](/help/forms/using/admin-help/configure-account-locking-settings.md)
      + {hide-from-toc}[Bestehende Domains bearbeiten und konvertieren](/help/forms/using/admin-help/editing-converting-existing-domains.md)
      + {hide-from-toc}[Konfigurieren von Authentifizierungsanbietern](/help/forms/using/admin-help/configuring-authentication-providers.md)
      + {hide-from-toc}[Synchronisieren von Ordnern](/help/forms/using/admin-help/synchronizing-directories.md)
      + {hide-from-toc}[Ordner konfigurieren](/help/forms/using/admin-help/configuring-directories.md)
    + Konfigurieren der Benutzerverwaltung {#configure-user-management}
      + {hide-from-toc}[Ändern der Reihenfolge der Auswertung für die Authentifizierung](/help/forms/using/admin-help/change-order-evaluation-authentication.md)
      + {hide-from-toc}[Konfigurieren des LDAP-Bindungskennworts](/help/forms/using/admin-help/configure-ldap-bind-password.md)
      + {hide-from-toc}[Konfigurieren von AEM Forms zum vorherigen Abrufen von Domain-Informationen](/help/forms/using/admin-help/configure-aem-forms-prefetch-domain.md)
      + {hide-from-toc}[Konfigurieren der zertifikatbasierten Authentifizierung](/help/forms/using/admin-help/configuring-certificate-based-authentication.md)
      + {hide-from-toc}[Konfigurieren der SAML-Dienstanbietereinstellungen](/help/forms/using/admin-help/configure-saml-service-provider-settings.md)
      + {hide-from-toc}[Aktivieren von Single Sign-on in AEM Forms](/help/forms/using/admin-help/enabling-single-sign-on-aem.md)
      + {hide-from-toc}[Konfigurieren Sie User Management für einen SSL-aktivierten LDAP-Server](/help/forms/using/admin-help/configure-user-management-ssl-enabled.md)
      + {hide-from-toc}[Konfigurationsdatei importieren und exportieren](/help/forms/using/admin-help/importing-exporting-configuration-file.md)
      + {hide-from-toc}[Konfigurieren von erweiterten Systemattributen](/help/forms/using/admin-help/configure-advanced-system-attributes.md)
      + {hide-from-toc}[CSRF-Angriffe verhindern](/help/forms/using/admin-help/preventing-csrf-attacks.md)
    + Einrichten und Organisation von Benutzerinnen und Benutzern {#setup-organize-users}
      + {hide-from-toc}[Hinzufügen und Konfigurieren von Benutzern](/help/forms/using/admin-help/adding-configuring-users.md)
      + {hide-from-toc}[Just-in-time-Benutzerbereitstellung](/help/forms/using/admin-help/just-in-time-user-provisioning.md)
      + {hide-from-toc}[Gruppen erstellen und konfigurieren](/help/forms/using/admin-help/creating-configuring-groups.md)
      + {hide-from-toc}[Nach einem Benutzer oder einer Gruppe suchen](/help/forms/using/admin-help/search-user-or-group.md)
      + {hide-from-toc}[Rollen erstellen und konfigurieren](/help/forms/using/admin-help/creating-configuring-roles.md)
    + Herstellen einer Verbindung mit einem Content-Management-System {#connect-content-management-system}
      + {hide-from-toc}[Connector für EMC Documentum konfigurieren®](/help/forms/using/admin-help/configuring-connector-emc-documentum.md)
      + {hide-from-toc}[Konfigurieren des Connectors für IBM® FileNet](/help/forms/using/admin-help/configuring-connector-ibm-filenet.md)
      + {hide-from-toc}[Konfigurieren des Connectors für IBM® Content Manager](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
      + {hide-from-toc}[Konfigurieren des Connectors für Microsoft SharePoint](/help/forms/using/admin-help/configuring-connector-microsoft-sharepoint.md)
    + Verwalten von Zertifikaten und Anmeldedaten {#manage-certificates-credentials}
      + {hide-from-toc}[Hinzufügen und Entfernen von Anmeldeinformationen mit Benutzernamen und Kennwort](/help/forms/using/admin-help/adding-removing-user-name-password.md)
      + {hide-from-toc}[Zertifikatsperrlisten verwalten](/help/forms/using/admin-help/certificate-revocation-lists.md)
      + {hide-from-toc}[Grundlagen zum Verwalten von Zertifikaten und Berechtigungen](/help/forms/using/admin-help/overview-2.md)
      + {hide-from-toc}[Zertifikate verwalten](/help/forms/using/admin-help/certificates.md)
      + {hide-from-toc}[Verwalten von HSM-Anmeldeinformationen](/help/forms/using/admin-help/hsm-credentials.md)
      + {hide-from-toc}[Lokale Anmeldeinformationen verwalten](/help/forms/using/admin-help/local-credentials.md)
    + Importieren und Verwalten von Anwendungen und Archiven {#import-manage-applications-archives}
      + {hide-from-toc}[Ändern der Anzahl der auf den Seiten „Anwendungen“ und „Dienste“ angezeigten Elemente](/help/forms/using/admin-help/change-number-items-displayed-applications.md)
      + {hide-from-toc}[Importieren und Verwalten von Archiven](/help/forms/using/admin-help/import-archives.md)
      + {hide-from-toc}[Anwendungen importieren und verwalten](/help/forms/using/admin-help/import-applications.md)
    + Verwalten von Services {#manage-services}
      + {hide-from-toc}[Diensteinstellungen konfigurieren](/help/forms/using/admin-help/configure-service-settings.md)
      + {hide-from-toc}[Starten und Beenden von Diensten](/help/forms/using/admin-help/starting-stopping-services.md)
    + Verwalten von Endpunkten {#manage-endpoints}
      + {hide-from-toc}[Hinzufügen, Aktivieren, Ändern oder Entfernen von Endpunkten](/help/forms/using/admin-help/adding-enabling-modifying-or-removing.md)
      + {hide-from-toc}[Konfigurieren von E-Mail-Endpunkten](/help/forms/using/admin-help/configuring-email-endpoints.md)
      + {hide-from-toc}[Konfigurieren der oAuth2.0-Authentifizierung](/help/forms/using/oauth2-support-for-mail-service.md)
      + {hide-from-toc}[Konfigurieren von Remoting-Endpunkten](/help/forms/using/admin-help/configuring-remoting-endpoints.md)
      + {hide-from-toc}[Endpunkte für überwachte Ordner konfigurieren](/help/forms/using/admin-help/configuring-watched-folder-endpoints.md)
      + {hide-from-toc}[Konfigurieren von Task Manager-Endpunkten](/help/forms/using/admin-help/configuring-task-manager-endpoints.md)
      + {hide-from-toc}[Typen von Endpunkten](/help/forms/using/admin-help/types-endpoints.md)
    + Konfigurieren von Acrobat Reader DC Extensions {#configure-acrobat-reader-dc-extensions}
      + {hide-from-toc}[Von Acrobat Reader DC Extensions verwendete Zertifikatstypen](/help/forms/using/admin-help/certificate-types-used-acrobat-reader.md)
      + {hide-from-toc}[Gültige und abgelaufene Zertifikate in PDF-Dokumenten erkennen](/help/forms/using/admin-help/recognizing-valid-expired-certificates-pdf.md)
      + {hide-from-toc}[Konfigurieren von Acrobat Reader DC Extensions für die Datenerfassung](/help/forms/using/admin-help/configuring-acrobat-reader-dc-extensions.md)
      + {hide-from-toc}[Informationen zur Verwendung der Berechtigung überprüfen](/help/forms/using/admin-help/review-credential-information.md)
      + {hide-from-toc}[Konfigurieren von Anmeldeinformationen zur Verwendung mit Acrobat Reader DC Extensions](/help/forms/using/admin-help/configuring-credentials-acrobat-reader-dc.md)
      + {hide-from-toc}[Überprüfen Sie die Verwendungsrechte einer PDF-Datei](/help/forms/using/admin-help/review-usage-rights-pdf-file.md)
      + {hide-from-toc}[Onlinekommentierung für das Adobe Reader-Webbrowser-Plug-in aktivieren](/help/forms/using/admin-help/enabling-online-commenting-reader-web.md)
      + {hide-from-toc}[Festlegen von Zeitüberschreitungswerten zur Verwendung mit Acrobat Reader DC Extensions](/help/forms/using/admin-help/setting-timeout-values-acrobat-reader.md)
      + {hide-from-toc}[Aktualisieren abgelaufener Reader Extension-Service-Zertifikate](/help/forms/using/admin-help/updating-expired-reader-extension-certificates.md)
    + Arbeiten mit PDF Generator {#work-with-pdf-generator}
      + {hide-from-toc}[Einführung in die Arbeit mit PDF Generator](/help/forms/using/admin-help/overview-5.md)
      + {hide-from-toc}[Aktivieren von Multi-Thread-Dateikonvertierungen](/help/forms/using/admin-help/enabling-multi-threaded-file-conversions.md)
      + {hide-from-toc}[Konfigurieren von Adobe PDF-Einstellungen](/help/forms/using/admin-help/configuring-pdf-settings.md)
      + {hide-from-toc}[Sicherheitseinstellungen konfigurieren](/help/forms/using/admin-help/configuring-security-settings.md)
      + {hide-from-toc}[Konfigurieren von Dateitypeinstellungen](/help/forms/using/admin-help/configuring-file-type-settings.md)
      + {hide-from-toc}[Importieren und Exportieren von PDF Generator-Konfigurationsdateien](/help/forms/using/admin-help/importing-exporting-pdf-generator-configuration.md)
      + {hide-from-toc}[Aktivieren der PDF/A-Unterstützung](/help/forms/using/admin-help/enable-pdf-a-support.md)
      + {hide-from-toc}[Einrichten eines PDFG-Netzwerkdruckers (nur Windows)](/help/forms/using/admin-help/setting-pdfg-network-printer-windows.md)
      + {hide-from-toc}[Ersatzschriftarten konfigurieren](/help/forms/using/admin-help/configuring-fallback-fonts.md)
      + {hide-from-toc}[Ändern der PDF-Exportkonvertierungseinstellungen](/help/forms/using/admin-help/modifying-pdf-export-conversion-settings.md)
      + {hide-from-toc}[Dateien mithilfe von PDF Generator konvertieren](/help/forms/using/admin-help/converting-files-using-pdf-generator.md)
    + Konfigurieren von SSL {#configure-ssl}
      + {hide-from-toc}[Überblick über die Konfiguration von SSL](/help/forms/using/admin-help/overview-6.md)
      + [Konfigurieren von SSL für JBoss® Application Server](/help/forms/using/admin-help/configuring-ssl-for-jboss-application-server-aem-forms-65-lts-jee.md)
      + {hide-from-toc}[Konfigurieren von SSL unter Windows Vista](/help/forms/using/admin-help/configuring-ssl-windows-vista.md)
      + {hide-from-toc}[Konfigurieren von SSL für WebSphere® Application Server](/help/forms/using/admin-help/configuring-ssl-websphere-application-server.md)
    + Arbeiten mit Dokumentensicherheit {#work-with-document-security}
      + {hide-from-toc}[Über Document Security](/help/forms/using/admin-help/document-security.md)
      + {hide-from-toc}[Bereitstellung von sicheren Informationen mit hohem Volumen](/help/forms/using/admin-help/high-volume-secure-information-delivery.md)
      + {hide-from-toc}[Client- und Serveroptionen konfigurieren](/help/forms/using/admin-help/configuring-client-server-options.md)
      + {hide-from-toc}[Konten eingeladener und lokaler Benutzer verwalten](/help/forms/using/admin-help/invited-local-user-accounts.md)
      + {hide-from-toc}[Steuern des Zugriffs auf richtliniengeschützte Dokumente](/help/forms/using/admin-help/controlling-access-policy-protected-documents.md)
      + {hide-from-toc}[Überwachen von Ereignissen](/help/forms/using/admin-help/monitoring-events.md)
      + {hide-from-toc}[Erstellen und Verwalten von Richtlinien](/help/forms/using/admin-help/creating-policies.md)
      + {hide-from-toc}[Verwenden der Document Security-Web-Seiten](/help/forms/using/admin-help/using-document-security-web-pages.md)
      + {hide-from-toc}[Erstellen und Verwalten von Richtliniensätzen](/help/forms/using/admin-help/creating-policy-sets.md)
      + {hide-from-toc}[Registrieren als Benutzer](/help/forms/using/admin-help/registering-as-a-user.md)
    + Formulare konfigurieren {#configure-forms}
      + {hide-from-toc}[Grundlagen zum Konfigurieren von Formularen](/help/forms/using/admin-help/overview-7.md)
      + {hide-from-toc}[Internationalisierungsoptionen festlegen](/help/forms/using/admin-help/setting-internationalization-options.md)
      + {hide-from-toc}[Konfigurieren der Zwischenspeicherung für Forms](/help/forms/using/admin-help/configuring-caching-forms.md)
      + {hide-from-toc}[Angeben der XCI-Konfigurationsoptionen](/help/forms/using/admin-help/specifying-xci-configuration-options.md)
      + {hide-from-toc}[Konfigurieren der Formularausgabe](/help/forms/using/admin-help/configuring-form-output.md)
      + {hide-from-toc}[Angeben der einzubettenden Schriftarten](/help/forms/using/admin-help/specifying-fonts-embed.md)
      + {hide-from-toc}[Konfigurieren von Speicherorten für Forms](/help/forms/using/admin-help/configuring-locations-forms.md)
      + {hide-from-toc}[Sicherheitseinstellungen festlegen](/help/forms/using/admin-help/specifying-security-settings.md)
      + {hide-from-toc}[Validierungsmeldungen konfigurieren](/help/forms/using/admin-help/configuring-validation-messages.md)
    + Output konfigurieren {#configure-output}
      + {hide-from-toc}[Übersicht über den Ausgabe-Service](/help/forms/using/admin-help/overview-8.md)
      + {hide-from-toc}[Angeben der XCI-Konfigurationsoptionen](/help/forms/using/admin-help/specify-xci-configuration-options.md)
      + {hide-from-toc}[Zwischenspeicherung für Ausgabe konfigurieren](/help/forms/using/admin-help/configuring-caching-output.md)
      + {hide-from-toc}[Angeben von Dateispeicherorten für die Ausgabe](/help/forms/using/admin-help/specify-file-locations-output.md)
      + {hide-from-toc}[Schriftarten verfügbar machen](/help/forms/using/admin-help/make-fonts-available.md)
      + {hide-from-toc}[Angeben der einzubettenden Schriftarten](/help/forms/using/admin-help/specify-fonts-embed.md)
      + {hide-from-toc}[Sicherheitseinstellungen angeben](/help/forms/using/admin-help/specify-security-settings.md)
      + {hide-from-toc}[Ändern des Zeichensatzes](/help/forms/using/admin-help/change-character-set.md)
    + Konfigurieren von Forms Workflow{#configure-forms-workflow}
      + {hide-from-toc}[Über Administrations- und Prozessterminologie](/help/forms/using/admin-help/administration-process-terminology.md)
      + {hide-from-toc}[Verwalten von Prozessen](/help/forms/using/admin-help/processes.md)
      + {hide-from-toc}[Geschäftskalender konfigurieren](/help/forms/using/admin-help/configuring-business-calendars.md)
      + {hide-from-toc}[Überblick über Forms Workflow](/help/forms/using/admin-help/overview-9.md)
      + {hide-from-toc}[Konfigurieren von Abwesenheitseinstellungen](/help/forms/using/admin-help/configuring-out-office-settings.md)
      + {hide-from-toc}[Suchen nach Prozessinstanzen](/help/forms/using/admin-help/searching-process-instances.md)
      + {hide-from-toc}[Servereinstellungen konfigurieren](/help/forms/using/admin-help/configuring-server-settings.md)
      + {hide-from-toc}[Arbeiten mit angehaltenen Vorgängen und Verzweigungen](/help/forms/using/admin-help/stalled-operations-branches.md)
      + {hide-from-toc}[Freigegebene Warteschlangen konfigurieren](/help/forms/using/admin-help/configuring-shared-queues.md)
      + {hide-from-toc}[Arbeiten mit Aufgaben](/help/forms/using/admin-help/tasks.md)
    + Konfigurieren von Workspace {#configure-workspace}
      + {hide-from-toc}[Überblick über Workspace](/help/forms/using/admin-help/overview-10.md)
      + {hide-from-toc}[Importieren und Exportieren globaler Einstellungen](/help/forms/using/admin-help/importing-exporting-global-settings.md)
      + {hide-from-toc}[Festlegen der Nachricht des Tages](/help/forms/using/admin-help/setting-message-day.md)
      + {hide-from-toc}[Anpassen von Suchvorlagen](/help/forms/using/admin-help/customizing-search-templates.md)
      + {hide-from-toc}[Verwalten der in Workspace angezeigten Kategorien](/help/forms/using/admin-help/categories-displayed-workspace.md)
    + Health Monitor (Statusüberwachung) {#health-monitor}
      + {hide-from-toc}[Übersicht über den Health Monitor](/help/forms/using/admin-help/overview-11.md)
      + {hide-from-toc}[Optimieren der Leistung von Health Monitor](/help/forms/using/admin-help/fine-tuning-health-monitor-performance.md)
      + {hide-from-toc}[Anzeigen von Statistiken zu Work Manager](/help/forms/using/admin-help/view-statistics-related-manager.md)
      + {hide-from-toc}[Systeminformationen anzeigen](/help/forms/using/admin-help/view-system-information.md)
      + {hide-from-toc}[Bereinigen von Datensätzen aus der Job Manager-Datenbank](/help/forms/using/admin-help/purge-records-job-manager-database.md)
    + Warten von AEM Forms {#maintain-aem-forms}
      + {hide-from-toc}[Protokolldateien](/help/forms/using/admin-help/log-files.md)
      + {hide-from-toc}[Benutzerverwaltung](/help/forms/using/admin-help/user-management.md)
      + {hide-from-toc}[Überwachen von AEM Forms-Bereitstellungen](/help/forms/using/admin-help/monitoring-aem-forms-deployments.md)
      + {hide-from-toc}[Work Manager und Einschränkungen](/help/forms/using/admin-help/manager-throttling.md)
    ...
    + Warten der AEM Forms-Datenbank {#maintain-aem-forms-database}
      ...
      + {hide-from-toc}[Tipps zur Minimierung des Datenbankwachstums](/help/forms/using/admin-help/tips-minimizing-database-growth.md)
    + Warten des Anwendungs-Servers {#manage-application-server}
      + {hide-from-toc}[Websites für Anwendungs-Server](/help/forms/using/admin-help/application-server-websites.md)
      + {hide-from-toc}[Ordner des globalen Dokumentenspeichers](/help/forms/using/admin-help/global-document-storage-directory.md)
      + {hide-from-toc}[Überlegungen beim Ausführen von Administration Console](/help/forms/using/admin-help/considerations-running-administration-console.md)
      + {hide-from-toc}[Verbessern der Leistung des Anwendungsservers](/help/forms/using/admin-help/enhancing-application-server-performance.md)
      + {hide-from-toc}[Starten und Anhalten des WebSphere®-Anwendungsservers](/help/forms/using/admin-help/starting-stopping-websphere-application-server.md)
    + Backup und Wiederherstellung von AEM-Formularen {#aem-forms-backup-recovery}
      + {hide-from-toc}[Sichern und Wiederherstellen des EMC Documentum®-Repositorys](/help/forms/using/admin-help/backing-recovering-emc-documentum-repository.md)
      + {hide-from-toc}[Aktivieren und Deaktivieren des abgesicherten Sicherungsmodus](/help/forms/using/admin-help/enabling-disabling-safe-backup-mode.md)
      + {hide-from-toc}[Sichern der AEM Forms-Daten](/help/forms/using/admin-help/backing-aem-forms-data.md)
      + {hide-from-toc}[Zu sichernde und wiederherzustellende Dateien](/help/forms/using/admin-help/files-back-recover.md)
      + {hide-from-toc}[Sicherungs- und Wiederherstellungsstrategie für AEM Forms](/help/forms/using/admin-help/backup-recovery-strategy-aem-forms.md)
      + {hide-from-toc}[Einschränkungen bei der PDF Generator-Sicherung](/help/forms/using/admin-help/pdf-generator-backup-limitations.md)
      + {hide-from-toc}[Sicherungsstrategien für überwachte Ordner](/help/forms/using/admin-help/backup-strategies-watched-folders.md)
      + [Wiederherstellen der AEM Forms-Daten](/help/forms/using/admin-help/recovering-aem-forms-data.md)
      + [Backup-Strategie für Benutzende des Connectors für EMC Documentum®](/help/forms/using/admin-help/backup-strategy-connector-emc-documentum.md)
      + {hide-from-toc}[Strategie für Sicherung und Wiederherstellung in einer Cluster-Umgebung](/help/forms/using/admin-help/strategy-backup-restore-clustered-environment.md)
    + Systeminformationsdienst {#system-information-service}
      + {hide-from-toc}[Einrichten des Systeminformationsdienstes](/help/forms/using/admin-help/set-system-information-service.md)
      + {hide-from-toc}[Systeminformationsdienst-APIs](/help/forms/using/admin-help/system-information-service-apis.md)
  + Prozessberichterstellung {#process-reporting}
    + {hide-from-toc}[Einführung in das Prozess-Reporting](/help/forms/using/process-reporting/introduction-process-reporting.md)
    + {hide-from-toc}[Erste Schritte mit Process Reporting](/help/forms/using/process-reporting/install-start-process-reporting.md)
    + {hide-from-toc}[Funktionsweise von Process Reporting](/help/forms/using/process-reporting/process-reporting-architecture.md)
    + {hide-from-toc}[Vordefinierte Berichte in Process Reporting](/help/forms/using/process-reporting/pre-defined-reports-in-process-reporting.md)
    + {hide-from-toc}[Benutzerdefinierte Berichte in Process Reporting](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
    + {hide-from-toc}[Ad-hoc-Abfragen in Process Reporting](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md)
    + {hide-from-toc}[Fehlerbehebung bei Process Reporting](/help/forms/using/process-reporting/troubleshooting-process-management.md)
  + Entwicklerreferenz {#developer-reference}
    ...
    + Programmieren mit AEM Forms auf JEE {#programming-aem-forms-jee}
      + Einführung in das Programmieren mit AEM Forms auf JEE {#introduction-programming-aem-forms-jee}
        + {hide-from-toc}[Einführung in Java API QuickStart](/help/forms/developing/introducing-java-api-soap-quick.md)
        + {hide-from-toc}[Aufrufen von AEM Forms mithilfe von APIs](/help/forms/developing/invoking-aem-forms-using-apis.md)
        + {hide-from-toc}[Grundlagen zu AEM Forms-Prozessen](/help/forms/developing/aem-forms-processes.md)
      ...
      + Entwickeln von SPIs für AEM Forms {#developing-spis-aem-forms}
        + {hide-from-toc}[Erstellen eines Handlers zum Einladen externer Benutzer](/help/forms/developing/creating-invite-external-users-handler.md)
      + Java API-Schnellstart – Code-Beispiele {#java-api-quick-start-code-examples}
        ...
        + {hide-from-toc}[JavaAPI-Schnellstart (SOAP) für den Application Manager-Dienst](/help/forms/developing/application-manager-service-java-api.md)
        + {hide-from-toc}[Schnellstart (SOAP) für die Assembler-Service-Java-API](/help/forms/developing/assembler-service-java-api-quick.md)
        + {hide-from-toc}[Schnellstart (SOAP) für die Java-API des Acrobat Reader DC-Erweiterungs-Services](/help/forms/developing/acrobat-reader-dc-extensions-service.md)
        + {hide-from-toc}[Sicherungs- und Wiederherstellungs-Service - API-Schnellstarts](/help/forms/developing/backup-restore-service-api-quick.md)
        + {hide-from-toc}[Barcoded Forms-Service Java-APIsSchnellstart (SOAP)](/help/forms/developing/barcoded-forms-service-java-api.md)
        + {hide-from-toc}[Komponenten und Dienste Java API-Schnellstart (SOAP)](/help/forms/developing/components-services-java-api-quick.md)
        + {hide-from-toc}[Convert PDF Service Java API QuickStart(SOAP)](/help/forms/developing/convert-pdf-service-java-api.md)
        + {hide-from-toc}[Berechtigungs-Service Java API Schnellstart(SOAP)](/help/forms/developing/credential-service-java-api-quick.md)
        + {hide-from-toc}[Schnellstart (SOAP) für die Distiller Service Java-API](/help/forms/developing/distiller-service-java-api-quick.md)
        + {hide-from-toc}[Kurzanleitung zur DocConverter-Service-Java-API(SOAP)](/help/forms/developing/docconverter-service-java-api-quick.md)
        + {hide-from-toc}[Document Management-Service (nicht mehr unterstützt)Java-API-Schnellstart(SOAP)](/help/forms/developing/document-management-service-deprecated-java.md)
        + {hide-from-toc}[Document Security-Service - JavaAPI-Schnellstart (SOAP)](/help/forms/developing/document-security-service-java-api.md)
        + {hide-from-toc}[Schnellstart (SOAP) für die Java-API des Verschlüsselungs-Services](/help/forms/developing/encryption-service-java-api-quick.md)
        + {hide-from-toc}[Endpoint Registry Java API QuickStart(SOAP)](/help/forms/developing/endpoint-registry-java-api-quick.md)
        + {hide-from-toc}[Formulardatenintegrationsdienst - JavaAPI-Schnellstart (SOAP)](/help/forms/developing/form-data-integration-service-java.md)
        + {hide-from-toc}[Kurzanleitungen zur Forms Service-API](/help/forms/developing/forms-service-api-quick-starts.md)
        + {hide-from-toc}[Generate PDF Service Java API QuickStart(SOAP)](/help/forms/developing/generate-pdf-service-java-api.md)
        + {hide-from-toc}[Kurzanleitungen für die Aufruf-API](/help/forms/developing/invocation-api-quick-starts.md)
        + {hide-from-toc}[Schnellstart für die LiveCycleProcess-Java-API (SOAP)](/help/forms/developing/livecycleprocess-java-api-soap-quick.md)
        + {hide-from-toc}[Schnellstart (SOAP) für die Java-API des Output-Dienstes](/help/forms/developing/output-service-java-api-quick.md)
        + {hide-from-toc}[Java-API-Schnellstart (SOAP) für den PDF Utilities-Service](/help/forms/developing/pdf-utilities-service-java-api.md)
        + {hide-from-toc}[Kurzanleitungen zur Repository Service-API](/help/forms/developing/repository-service-api-quick-starts.md)
        + {hide-from-toc}[Schnellstart (SOAP) für die Signature-Dienst-Java-API](/help/forms/developing/signature-service-java-api-quick.md)
        + {hide-from-toc}[Java API-Schnellstart (SOAP) für den Task Manager-Dienst](/help/forms/developing/task-manager-service-java-api.md)
        + {hide-from-toc}[Kurzanleitung zur User Manager-Java-API (SOAP)](/help/forms/developing/user-manager-java-api-quick.md)
        + {hide-from-toc}[Java-API-Schnellstart (SOAP) für den XMP Utilities-Service](/help/forms/developing/xmp-utilities-service-java-api.md)
      + Aufrufen von AEM Forms auf JEE mithilfe von APIs {#invoking-aem-forms-jee-apis}
        + {hide-from-toc}[Aufrufen von AEM Forms mithilfe von REST-Anfragen](/help/forms/developing/invoking-aem-forms-using-rest.md)
        + {hide-from-toc}[Aufrufen von AEM Forms mithilfe von Web-Services](/help/forms/developing/invoking-aem-forms-using-web.md)
        + {hide-from-toc}[Aufrufen von AEM Forms mithilfe von Remoting](/help/forms/developing/invoking-aem-forms-using-remoting.md)
        + {hide-from-toc}[Aufrufen von AEM Forms mithilfe von Web-Services](/help/forms/developing/invoking-human-centric-long-lived.md)
        + {hide-from-toc}[Aufrufen von AEM Forms mithilfe der Java-API](/help/forms/developing/invoking-aem-forms-using-java.md)
        + {hide-from-toc}[Erstellen von Flash Builder-Anwendungen, die SSO-Authentifizierung mithilfe von HTTP-Token durchführen](/help/forms/developing/creating-flash-builder-applications-perform.md)
      + Ausführen von Service-Vorgängen mithilfe von APIs {#performing-service-operations-using-apis}
        + {hide-from-toc}[Ausführen von Service-Vorgängen mithilfe von APIs](/help/forms/developing/performing-service-operations-using-apis.md)
        + {hide-from-toc}[Rendern von Forms](/help/forms/developing/rendering-forms.md)
        + {hide-from-toc}[Zusammenstellen von PDF-Dokumenten](/help/forms/developing/assembling-pdf-documents.md)
        + {hide-from-toc}[Programmgesteuertes Zusammenstellen von PDF-Dokumenten](/help/forms/developing/programmatically-assembling-pdf-documents.md)
        + {hide-from-toc}[Konvertieren zwischen Dateiformaten und PDF](/help/forms/developing/converting-file-formats-pdf.md)
        + {hide-from-toc}[Programmgesteuertes Aufteilen von PDF-Dokumenten](/help/forms/developing/programmatically-disassembling-pdf-documents.md)
        + {hide-from-toc}[Zusammenstellen verschlüsselter PDF-Dokumente](/help/forms/developing/assembling-encrypted-pdf-documents.md)
        + {hide-from-toc}[Zusammenstellen mehrerer XDP-Fragmente](/help/forms/developing/assembling-multiple-xdp-fragments.md)
        + {hide-from-toc}[Zusammenstellen von Dokumenten mit Bates-Nummerierung](/help/forms/developing/assembling-documents-using-bates-numbering.md)
        + {hide-from-toc}[Zusammenstellen nicht interaktiver PDF-Dokumente](/help/forms/developing/assembling-non-interactive-pdf-documents.md)
        + {hide-from-toc}[Zusammenstellen von PDF-Dokumenten mit Lesezeichen](/help/forms/developing/assembling-pdf-documents-bookmarks.md)
        + {hide-from-toc}[Zuweisen von Verwendungsrechten](/help/forms/developing/assigning-usage-rights.md)
        + {hide-from-toc}[Zusammenstellen von PDF-Portfolios](/help/forms/developing/assembling-pdf-portfolios.md)
        + {hide-from-toc}[Berechnen von Formulardaten](/help/forms/developing/calculating-form-data.md)
        + {hide-from-toc}[Erstellen von Web-Anwendungen, die Forms rendern](/help/forms/developing/creating-web-applications-renders-forms.md)
        + {hide-from-toc}[Erstellen von PDF-Dokumenten mit SubmittedXML-Daten](/help/forms/developing/creating-pdf-documents-submitted-xml.md)
        + {hide-from-toc}[Aufteilen eines PDF-Dokuments mithilfe der Webservice-API](/help/forms/developing/disassemble-pdf-document-using-web.md)
        + {hide-from-toc}[Ermitteln, ob Dokumente PDF/A-konform sind](/help/forms/developing/determining-whether-documents-pdf-a.md)
        + {hide-from-toc}[Dynamisches Erstellen von DDX-Dokumenten](/help/forms/developing/dynamically-creating-ddx-documents.md)
        + {hide-from-toc}[Umgang mit gesendeten Forms](/help/forms/developing/handling-submitted-forms.md)
        + {hide-from-toc}[Optimieren der Leistung des Forms-Service](/help/forms/developing/optimizing-performance-forms-service.md)
        + {hide-from-toc}[Übergeben von Dokumenten an den FormsService](/help/forms/developing/passing-documents-forms-service.md)
        + {hide-from-toc}[Vorausfüllen von Forms mit flexiblen Layouts](/help/forms/developing/prepopulating-forms-flowable-layouts.md)
        + {hide-from-toc}[Rendern von Forms basierend auf Fragmenten](/help/forms/developing/rendering-forms-based-fragments.md)
        + {hide-from-toc}[Rendern von Forms anhand eines Werts](/help/forms/developing/rendering-forms-value.md)
        + {hide-from-toc}[Rendern von Forms als HTML](/help/forms/developing/rendering-forms-html.md)
        + {hide-from-toc}[Rendern von Forms auf dem Client](/help/forms/developing/rendering-forms-client.md)
        + {hide-from-toc}[Rendern von HTML Forms mithilfe benutzerdefinierter CSS-Dateien](/help/forms/developing/rendering-html-forms-using-custom.md)
        + {hide-from-toc}[Rendern von HTML Forms mit CustomToolbars](/help/forms/developing/rendering-html-forms-custom-toolbars.md)
        + {hide-from-toc}[Rendern von interaktiven PDF forms](/help/forms/developing/rendering-interactive-pdf-forms.md)
        + {hide-from-toc}[Rendering von berechtigungsaktiviertem Forms](/help/forms/developing/rendering-rights-enabled-forms.md)
        + {hide-from-toc}[Validieren von DDX-Dokumenten](/help/forms/developing/validating-ddx-documents.md)
        + {hide-from-toc}[Konvertieren von PDF in PostScript- und Bilddateien](/help/forms/developing/converting-pdf-postscript-image-files.md)
        + {hide-from-toc}[Konvertieren von PostScript in PDF-Dokumente](/help/forms/developing/converting-postscript-pdf-documents.md)
        + {hide-from-toc}[Erstellen von Dokumentausgabe-Streams](/help/forms/developing/creating-document-output-streams.md)
        + {hide-from-toc}[Digitales Signieren und Zertifizieren von Dokumenten](/help/forms/developing/digitally-signing-certifying-documents.md)
        + {hide-from-toc}[Verschlüsseln und Entschlüsseln von PDF-Dokumenten](/help/forms/developing/encrypting-decrypting-pdf-documents.md)
        + {hide-from-toc}[Importieren und Exportieren von Daten](/help/forms/developing/importing-exporting-data.md)
        + {hide-from-toc}[Verwalten von Benutzern](/help/forms/developing/users.md)
        + {hide-from-toc}[Arbeiten mit dem AEM Forms-Repository](/help/forms/developing/aem-forms-repository.md)
        + {hide-from-toc}[Arbeiten mit Barcoded Forms](/help/forms/developing/barcoded-forms.md)
        + {hide-from-toc}[Arbeiten mit Anmeldeinformationen](/help/forms/developing/credentials.md)
        + {hide-from-toc}[Arbeiten mit PDF/A-Dokumenten](/help/forms/developing/pdf-a-documents.md)
        + {hide-from-toc}[Arbeiten mit PDF Utilities](/help/forms/developing/pdf-utilities.md)
        + {hide-from-toc}[Arbeiten mit XMP Utilities](/help/forms/developing/xmp-utilities.md)
        + {hide-from-toc}[Vorbereiten von AEM Forms für die Sicherung](/help/forms/developing/preparing-aem-forms-backup.md)
        + {hide-from-toc}[Programmgesteuertes Verwalten von Endpunkten](/help/forms/developing/programmatically-endpoints.md)
        + {hide-from-toc}[Programmgesteuerte Verwaltung der Voreinstellungsknoten](/help/forms/developing/programmatically-preferences-nodes.md)
        + {hide-from-toc}[Schützen von Dokumenten mit Richtlinien](/help/forms/developing/protecting-documents-policies.md)
        + {hide-from-toc}[Validieren eines DDX-Dokuments mithilfe der Webservice-API](/help/forms/developing/validate-ddx-document-using-web.md)
  + Fehlerbehebung {#troubleshooting}
    ...
    + {hide-from-toc}[Zusätzliche Schritte zum Abrufen von E-Mails mit Anhängen für die adaptive Forms on JEE-Version](/help/forms/using/additional-steps-to-use-email-with-attachments.md)
    + {hide-from-toc}[Word- oder Excel-Datei kann unter Windows Server nicht in PDF konvertiert werden](/help/forms/using/disable-uac-for-pdfgconfiguration.md)
    + {hide-from-toc}[XFA-basierte PDF forms kann nicht in Google Chrome, Firefox, Microsoft Edge, Microsoft Internet Explorer oder Apple Safari geöffnet werden](/help/forms/using/xfa-based-forms-in-chrome-firefox-ie-internet-explorter-safari-edge.md)
    + {hide-from-toc}[CRX-Repository kann nicht wiederhergestellt werden](/help/forms/using/restore-crx-repository.md)
    + {hide-from-toc}[Dokumente werden auch dann verarbeitet, wenn der AEM Forms-Server nicht vollständig ausgeführt wird](/help/forms/using/processing-documents-even-if-aem-forms-server-not-fully-up.md)
    + {hide-from-toc}[Ausgabe-Service, Forms-Service oder DoR-Service (Document of Record) können nicht verwendet werden](/help/forms/using/connection-issues-with-output-forms-and-document-of-record-dor-services.md)
    + {hide-from-toc}[Beim Generieren von PDF kann keine große Anzahl von PDFs auf WorkBench gedruckt werden](/help/forms/using/pdf-generation-service-fails-to-print-a-large-number-of-pdfs-on-workbench.md)
    + {hide-from-toc}[So starten Sie AEM SDK ordnungsgemäß neu](/help/forms/using/restart-aem-sdk.md)
    ...
    + [AEM Forms blockiert gültige HTTP-Anfragen](/help/forms/troubleshooting/aem-forms-blocks-valid-http-requests.md)
  + Alte Dokumentation {#legacy-documentation}
    ...
    + {hide-from-toc}[Konfigurieren und Fehlerbehebung für einen AEM Forms on JEE-Servercluster](/help/forms/developing/configure-server-cluster.md)
    + {hide-from-toc}[Generieren und Verwenden von Hashes in Dynamic PDF forms](/help/forms/developing/hashing-forms.md)
    + {hide-from-toc}[Übergeben von Anmeldeinformationen mithilfe von WS-Security-Kopfzeilen](/help/forms/developing/passing-credentials.md)
+ KI in AEM {#ai-in-aem}
...
+ Content and Commerce {#commerce}
  ...
  + Integrationen {#integrations}
    ...
    + [Commerce-Lösung eines Drittanbieters](/help/commerce/cif/integrating/third-party.md)
  + AEM-Storefront {#storefront}
    ...
    + Entwicklung {#developing}
      ...
      + [Verwenden von CIF-Katalogauswahlen](/help/commerce/cif/customizing/use-cif-pickers.md)
  + [Adobe Commerce PWA Studio](/help/commerce/cif/pwa-studio/getting-started.md)
  + [Migration](/help/commerce/cif/migration.md)
  + [Häufig gestellte Fragen](/help/commerce/cif/faq.md)
+ Headless {#headless}
  + [AEM Headless-Touren](/help/journey-headless/overview.md)
  + Entwickler-Tour für AEM Headless {#developer}
    + [Grundlegendes zu Headless in AEM](/help/journey-headless/developer/overview.md)
    ...
    + [Der Weg zu Ihrem ersten Erlebnis mit AEM Headless](/help/journey-headless/developer/path-to-first-experience.md)
    ...
    + [Live-Schalten Ihrer Headless-Anwendung](/help/journey-headless/developer/go-live.md)
    + [Optional – Erstellen von Single Page Applications (SPAs) mit AEM](/help/journey-headless/developer/create-spa.md)
  + Tour für Architektinnen und Architekten von AEM Headless-Inhalten {#architect}
    + [Überblick über die Tour für Architektinnen und Architekten von Headless-Inhalten](/help/journey-headless/architect/overview.md)
  ...
  + Tour für Erstellende von AEM Headless-Inhalten {#author}
    + [Tour zum Headless-Content-Authoring – Überblick](/help/journey-headless/author/overview.md)
    ...
    + [Informationen zur Definition von Metadaten und zum Tagging für Inhaltsfragmente](/help/journey-headless/author/metadata-tagging.md)
  + Tour zur AEM Headless-Übersetzung {#translation}
    + [Grundlegendes zur Headless-Übersetzung in AEM](/help/journey-headless/translation/overview.md)
    + [Erste Schritte mit der AEM Headless-Übersetzung](/help/journey-headless/translation/getting-started.md)
    + [Informationen zu Headless-Inhalten und dazu, wie sie in AEM übersetzt werden](/help/journey-headless/translation/learn-about.md)
...
+ Implementieren {#implementing}
  + Entwicklung {#developing}
    ...
    + Platform {#platform}
      ...
      + [Verwenden der Sling-Ressourcen-Zusammenführung in AEM](/help/sites-developing/sling-resource-merger.md)
      + [Überlagerungen](/help/sites-developing/overlays.md)
      + [Benennungskonventionen](/help/sites-developing/naming-conventions.md)
      + [Erstellen einer neuen Feldkomponente in der Granite-Benutzeroberfläche](/help/sites-developing/granite-ui-component.md)
      + Query Builder{#query-builder}
        + [Implementieren eines benutzerdefinierten Prädikat-Auswerters für den Abfrage-Builder](/help/sites-developing/implementing-custom-predicate-evaluator.md)
        + [Abfrage-Builder-Prädikatsreferenz](/help/sites-developing/querybuilder-predicate-reference.md)
      ...
      + [Herstellen einer Verbindung mit SQL-Datenbanken](/help/sites-developing/jdbc.md)
    ...
    + Komponenten{#components}
      ...
      + [Stilsystem](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/sites/authoring/siteandpage/style-system.html?lang=de)
    ...
    + Management von Headless-Erlebnissen {#headless}
      ...
      + Headless-Touren {#journeys}
        + Headless-Entwickler-Tour {#developer}
          + [Grundlegendes zu Headless-Technologie in AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/overview.html?lang=de)
          + [Informationen zur CMS-Headless-Entwicklung](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/learn-about.html?lang=de)
          + [Erste Schritte mit AEM Headless as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/getting-started.html?lang=de)
          + [Der Weg zu Ihrem ersten Erlebnis mit AEM Headless](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/path-to-first-experience.html?lang=de)
          + [Modellieren Ihres Inhalts als AEM-Inhaltsmodelle](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/model-your-content.html?lang=de)
          + [Zugreifen auf Ihre Inhalte über AEM-Bereitstellungs-APIs](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/access-your-content.html?lang=de)
          + [Aktualisieren Ihrer Inhalte über AEM Assets-APIs](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/update-your-content.html?lang=de)
          + [So legen Sie alles zusammen](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/put-it-all-together.html?lang=de)
          + [Live-Schalten Ihrer Headless-Anwendung](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/go-live.html?lang=de)
          + [Optional – Erstellen von Single Page Applications (SPAs) mit AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/developer/create-spa.html?lang=de)
        + Tour für Architektinnen und Architekten von Headless-Inhalten {#architect}
          + [Überblick über die Tour für Architektinnen und Architekten von Headless-Inhalten](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/overview.html?lang=de)
          + [Inhaltsmodellierung für Headless mit AEM – Einführung](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/introduction.html?lang=de)
          + [Lernen Sie die Grundlagen der Inhaltsmodellierung für Headless mit AEM kennen.](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/basics.html?lang=de)
          + [Erfahren Sie mehr über das Erstellen von Inhaltsfragmentmodellen in AEM](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/headless/architect/model-structure.html?lang=de)
      ...
      + Inhaltsfragmente{#content-fragments}
        + [Headless-Bereitstellung mit Inhaltsfragmenten und GraphQL](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-graphql.html?lang=de)
        + [Arbeiten mit Inhaltsfragmenten](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments.html?lang=de)
        + [Aktivieren der Funktionen für Inhaltsfragmente für Ihre Instanz](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-configuration-browser.html?lang=de)
        + [Inhaltsfragmentmodelle](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-models.html?lang=de)
        + [Verwalten von Inhaltsfragmenten](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-managing.html?lang=de)
        + [Varianten – Erstellen von Fragmentinhalten](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-variations.html?lang=de)
        + [Markdown](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-markdown.html?lang=de)
        + [Verwenden von zugehörigen Inhalten](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-assoc-content.html?lang=de)
        + [Metadaten – Fragmenteigenschaften](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-metadata.html?lang=de)
        + [Strukturbaum](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-structure-tree.html?lang=de)
        + [Vorschau – JSON-Darstellung](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/content-fragments/content-fragments-json-preview.html?lang=de)
      + Bereitstellungs-API{#delivery-api}
        + [Assets-HTTP-API](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/mac-api-assets.html?lang=de)
        + [Inhaltsfragment-REST-API](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/assets-api-content-fragments.html?lang=de)
        + [GraphQL-API für Inhaltsfragmente](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphql-api-content-fragments.html?lang=de)
        + [Verwalten von GraphQL-Endpunkten](/help/sites-developing/headless/graphql-api/graphql-endpoint.md)
        + [Verwenden der GraphiQL-IDE](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphiql-ide.html?lang=de)
        + [Persistierte Abfragen](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/persisted-queries.html?lang=de)
        ...
        + [Authentifizierung für Remote-AEM-GraphQL-Abfragen für Inhaltsfragmente](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/graphql-authentication-content-fragments.html?lang=de)
        + [AEM GraphQL-API mit Inhaltsfragmenten - Beispielinhalt und Abfragen](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/assets/extending/content-fragments-graphql-samples.html?lang=de)
    ...
    + Erweitern von AEM {#extending-aem}
      + [Erweitern von AEM mit Adobe Developer App Builder](/help/sites-developing/app-builder.md)
      ...
      + [Konfigurieren einer Seite für die Massenbearbeitung von Seiteneigenschaften](/help/sites-developing/bulk-editing.md)
      ...
      + Cloud Services{#extending-cloud-services}
        ...
        + [Erstellen eines benutzerdefinierten Cloud-Diensts](/help/sites-developing/extending-cloud-config-custom-cloud.md)
      ...
      + Erweitern der klassischen Benutzeroberfläche{#extending-classic-ui}
        ...
        + [Entwickeln von Berichten](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/platform/dev-reports.html?lang=de)
    + Testen {#testing}
      ...
      + [Testen der Benutzeroberfläche](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/components/hobbes.html?lang=de)
    + Best Practices {#bestpractices}
      + [Überblick über Best Practices](/help/sites-developing/best-practices.md)
      + [AEM-Entwicklungsrichtlinien und Best Practices](https://experienceleague.adobe.com/docs/experience-manager-65-lts/content/implementing/developing/introduction/dev-guidelines-bestpractices.html?lang=de)
  ...
  + Bereitstellen {#deploying}
    + Einführung in die AEM-Plattform {#introduction}
      ...
      + [Speicherelemente in AEM](/help/sites-deploying/storage-elements-in-aem-6.md)
    ...
    + Bereitstellen von AEM {#deploying}
      ...
      + [Offline-Neuindizierung für AEM](/help/sites-deploying/offline-reindexing.md)
    ...
    + Konfigurieren von AEM {#configuring}
      ...
      + {hide-from-toc}[Versionsbereinigung](/help/sites-deploying/version-purging.md)
    ...
    + Aktualisieren auf AEM 6.5 LTS {#upgrading}
      ...
      + {hide-from-toc}[Bewertung der Komplexität der Aktualisierung mit dem Musterdetektor](/help/sites-deploying/pattern-detector.md)
      + [Bewerten der Aktualisierungskomplexität mit dem AEM Analyzer](/help/sites-deploying/aem-analyzer.md)
      + {hide-from-toc}[Abwärtskompatibilität in AEM 6.5 LTS](/help/sites-deploying/backward-compatibility.md)
      ...
      + {hide-from-toc}[Verwenden des CRX2Oak-Migrations-Tools](/help/sites-deploying/using-crx2oak.md)
      ...
      + [Prüfungen und Fehlerbehebung nach dem Upgrade](/help/sites-deploying/post-upgrade-checks-and-troubleshooting.md)
      + {hide-from-toc}[Aktualisieren von Custom Search Forms](/help/sites-deploying/upgrading-custom-search-forms.md)
      + {hide-from-toc}[Nachhaltige Upgrades](/help/sites-deploying/sustainable-upgrades.md)
...
+ Verwalten {#managing}
  ...
  + Barrierefreiheit {#accessibility}
    + [AEM und die Richtlinien für barrierefreie Web-Inhalte](/help/managing/web-accessibility.md)
    + [Kurzanleitung zu WCAG 2.1](/help/managing/qg-wcag.md)
  + Datenschutz {#data-protection}
    + [AEM – Bereitschaft in Bezug auf Datenschutzbestimmungen und Datenschutzvorschriften](/help/managing/data-protection-and-privacy.md)
